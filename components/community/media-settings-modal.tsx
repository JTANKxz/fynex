...
export function MediaSettingsModal({ audioInputs, selectedAudioInput, onAudioInput, noiseSuppression, noiseSuppressionSupported, echoCancellation, autoGainControl, onProcessing, screenPreset, onScreenPreset, onClose }: {
