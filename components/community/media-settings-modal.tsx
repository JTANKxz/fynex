...
import { Mic, MonitorUp, SlidersHorizontal, X } from "lucide-react";

export type ScreenPreset = "economy" | "standard";

export function MediaSettingsModal({ audioInputs, selectedAudioInput, onAudioInput, noiseSuppression, echoCancellation, autoGainControl, onProcessing, screenPreset, onScreenPreset, onClose }: {
